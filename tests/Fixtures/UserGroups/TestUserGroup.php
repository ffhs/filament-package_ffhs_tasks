...
class TestUserGroup extends Model implements TaskUserGroupInterface
{
    use HasFactory;

    protected $table = 'first_user_groups';

    protected $guarded = [];

    public static function label(): string
    {
        return 'Test User Group';
    }
    ...
    protected static function newFactory(): TestUserGroupFactory
    {
        return new TestUserGroupFactory();
    }
}
